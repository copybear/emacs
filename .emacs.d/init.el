...
(custom-set-variables
 ...
 '(package-selected-packages
   '(gxref xref ob-mermaid mermaid-mode centaur-tabs treemacs-projectile treemacs-tab-bar treemacs-nerd-icons ellama treemacs-all-the-icons all-the-icons treemacs company clj-refactor cider clojure-mode doom-modeline doom-themes vertico-prescient nerd-icons-completion vertico-posframe nerd-icons vertico elfeed-org elfeed arjen-grey-theme chocolate-theme afternoon-theme github-dark-vscode-theme greymatters-theme sublime-themes material-theme calmer-forest-theme zenburn-theme howm elscreen undo-tree undohist wgrep multi-term htmlize helm-c-moccur auto-complete package-utils emojify org-ac org2blog multi-vterm magit ac-emoji helm-projectile projectile helm-gtags gtags exec-path-from-shell quickrun web-mode howm elscreen undo-tree undohist wgrep multi-term htmlize helm-c-moccur auto-complete)))
;; (custom-set-faces
